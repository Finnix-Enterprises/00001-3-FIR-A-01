...
// API endpoints
const char *apiEndpoint1 =
    "https://json-placeholder.mock.beeceptor.com/companies/"
    "1"; //"https://json-placeholder.mock.beeceptor.com/comments/{comment_id}";
...
void loop() {
  ...
  Serial.print("Read tampering: pin 18:");
  Tamp2_1 = digitalRead(18);
  Tamp2_2 = digitalRead(19);
  if (Tamp2_1 == Tamp2_2) {
    Serial.println("No tamper");
  } else
    Serial.println("Tampering has occured");
...
void fetchAPIData() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    // Safari/537.36"); // Simulating Chrome browser http.addHeader("Accept",
    // "application/json, text/plain, */*"); http.addHeader("Accept-Language",
    // "en-US,en;q=0.9"); http.addHeader("Connection", "keep-alive");
